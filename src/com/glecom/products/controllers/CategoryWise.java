...
/**
 * Servlet implementation class CategoryWise
 */
/**
 * @author navneet
 * categoyywise list of products.
 */
@WebServlet("/CategoryWise")
public class CategoryWise extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			productList = productDao.getFromCategory(category,12);
